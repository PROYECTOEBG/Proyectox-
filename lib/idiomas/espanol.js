...
//AVISOS DE MENSAJE
const smsAvisoRG = () => { return `𝙋𝙧𝙤𝙮𝙚𝙘𝙩𝙤𝙓\n\n` } 
...
const smsAvisoEG = () => { return `𝙋𝙧𝙤𝙮𝙚𝙘𝙩𝙤𝙓\n\n` }
...
const smsUnreg = () => { return `𝘗𝘰𝘳 𝘧𝘢𝘷𝘰𝘳 , 𝘳𝘦𝘨𝘪𝘴𝘵𝘳𝘢𝘵𝘦 𝘦𝘯 𝘮𝘪 𝘣𝘢𝘴𝘦 𝘥𝘦 𝘥𝘢𝘵𝘰𝘴 𝘶𝘴𝘢𝘯𝘥𝘰 𝘦𝘭 𝘤𝘰𝘮𝘢𝘯𝘥𝘰 .𝘷𝘦𝘳𝘪𝘧𝘪𝘤𝘢𝘳` }//VERIFICAR
...
//_antiviewonce.js
const smsAntiView = () => { return `*YO TODO LO VEO MI PANA JAJAJA*.`} 
...
//grupo-tagall.js
const smstagaa = () => { return `¡𝙍𝙀𝙋𝙊𝙍𝙏𝙀𝙉𝙎𝙀 𝘽𝘼𝙎𝙐𝙍𝘼𝙎!`}
...
const smsJBConexionTrue2 = () => { return `𝗖𝗼𝗻𝗲𝘅𝗶𝗼́𝗻 𝗲𝘅𝗶𝘁𝗼𝘀𝗮. ✅\n\n¡𝖦𝗋𝖺𝖼𝗂𝖺𝗌 𝗉𝗈𝗋 𝗎𝗍𝗂𝗅𝗂𝗓𝖺𝗋 𝗇𝗎𝖾𝗌𝗍𝗋𝗈𝗌 𝗌𝖾𝗋𝗏𝗂𝖼𝗂𝗈𝗌!\n𝙋𝙧𝙤𝙮𝙚𝙘𝙩𝙤𝙓 // 𝙀𝙡𝙞𝙩𝙚 𝘽𝙤𝙩 𝙂𝙡𝙤𝙗𝙖𝙡`}
const smsJBCargando = () => { return `𝗖𝗼𝗻𝗲𝘅𝗶𝗼́𝗻 𝗲𝘅𝗶𝘁𝗼𝘀𝗮. ✅\n\n¡𝖦𝗋𝖺𝖼𝗂𝖺𝗌 𝗉𝗈𝗋 𝗎𝗍𝗂𝗅𝗂𝗓𝖺𝗋 𝗇𝗎𝖾𝗌𝗍𝗋𝗈𝗌 𝗌𝖾𝗋𝗏𝗂𝖼𝗂𝗈𝗌!\n𝙋𝙧𝙤𝙮𝙚𝙘𝙩𝙤𝙓 // 𝙀𝙡𝙞𝙩𝙚 𝘽𝙤𝙩 𝙂𝙡𝙤𝙗𝙖𝙡`}
