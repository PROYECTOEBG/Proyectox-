...
let parentw = conn
if (conn.user.jid !== global.conn.user.jid) return parentw.reply(m.chat, `💻 Hola humano, para adquirir el servicio de proyectoX contáctate a mi privado\n👉🏻 +593993370003`, m) 
...
browser: mcode ? ['Ubuntu', 'Chrome', '110.0.5585.95'] : ['ProyectoX', 'Opera', '5.0'],
